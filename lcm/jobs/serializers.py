...
class JobHistorySerializer(serializers.Serializer):
    ...
    statusDescription = serializers.CharField(help_text="Description of job", required=False, allow_empty=True, allow_null=True)
    errorCode = serializers.CharField(help_text="Error code of job", required=False, allow_empty=True, allow_null=True)
