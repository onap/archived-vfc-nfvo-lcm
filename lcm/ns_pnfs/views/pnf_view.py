...
class PnfView(APIView):
    ...
    def post(self, request):
        ...
        resp_serializer = PnfInstanceSerializer(data=pnfInst2Json(pnfInstData))
    ...
    def get(self, request):
        try:
            ...
            resp_serializer = PnfInstancesSerializer(data=[pnfInst2Json(pnfInstData) for pnfInstData in pnfInstDataSet])
            if not resp_serializer.is_valid():
...
def pnfInst2Json(PnfInstData):
    return {
        "pnfId": PnfInstData.pnfId,
        "pnfName": PnfInstData.pnfName,
        "pnfdId": PnfInstData.pnfdId,
        "pnfdInfoId": PnfInstData.pnfdInfoId,
        "pnfProfileId": PnfInstData.pnfProfileId,
        "cpInfo": PnfInstData.cpInfo,
        "emsId": PnfInstData.emsId,
        "nsInstances": PnfInstData.nsInstances,
    }
