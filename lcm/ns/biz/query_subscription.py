...
ROOT_FILTERS = {
    ...
    'nsComponentTypes': 'nscomponent_types',
    'lcmOpNameImpactingNsComponent': 'lcmopname_impacting_nscomponent',
    'lcmOpOccStatusImpactingNsComponent': 'lcmopoccstatus_impacting_nscomponent'
}
NS_INSTANCE_FILTERS = {
...
class QuerySubscription:
    ...
    def fill_resp_data(self, subscription):
        subscription_filter = {
            ...
            "nsComponentTypes": ast.literal_eval(subscription.nscomponent_types),
            "lcmOpNameImpactingNsComponent ": ast.literal_eval(subscription.lcmopname_impacting_nscomponent),
            "lcmOpOccStatusImpactingNsComponent": ast.literal_eval(subscription.lcmopoccstatus_impacting_nscomponent),
            "nsInstanceSubscriptionFilter": json.loads(subscription.lcmopoccstatus_impacting_nscomponent)
        }
        resp_data = {
