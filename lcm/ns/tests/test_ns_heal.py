...
class TestHealNsViews(TestCase):
    ...
    def test_heal__vnf_manual_scale_thread(self, mock_start, mock_wait, mock_update):
    ...
    @mock.patch.object(NSHealService, 'wait_job_finish')
    @mock.patch.object(NSHealService, 'update_job')
    def test_heal_ns_manual_scale_thread(self, mock_start, mock_wait, mock_update):
