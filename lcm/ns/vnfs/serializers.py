...
class SolutionSerializer(serializers.Serializer):
    placementSolutions = serializers.ListField(
        ...
        child=ComprehensiveSolutionSerializer(help_text="One Placement Solution", required=True),
        required=True,
        allow_blank=True
    )
    licenseSolutions = serializers.ListField(
        help_text="A list of License Solutions",
        child=LicenseSolutionSerializer(help_text="One License Solution", required=True),
        required=True,
        allow_blank=True
    )
