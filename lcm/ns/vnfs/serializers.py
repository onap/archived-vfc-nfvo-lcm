...
class PlacementSolutionSerializer(serializers.Serializer):
    ...
    assignmentInfo = serializers.ListField(
        ...
        child=AssignmentInfoSerializer(help_text="Additonal information related to a candidate",
                                                   required=True),
        required=False,
        allow_empty=True
    )
...
class ComprehensiveSolutionSerializer(serializers.ListField):
    child = PlacementSolutionSerializer(help_text="A list of placement solutions", required=True)


class SolutionSerializer(serializers.Serializer):
    placementSolutions = serializers.ListField(
        help_text="A list of Placement Solutions",
        child=ComprehensiveSolutionSerializer(help_text="One Placement Solution", required=True, allow_blank=True),
        required=True,
        allow_empty=True
    )
    licenseSolutions = serializers.ListField(
        help_text="A list of License Solutions",
        child=LicenseSolutionSerializer(help_text="One License Solution", required=True, allow_blank=True),
        required=True,
        allow_empty=True
    )
