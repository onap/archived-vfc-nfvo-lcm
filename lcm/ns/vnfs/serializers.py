...
class PlaceVnfReqSerializer(serializers.Serializer):
    ...
    solutions = serializers.SolutionSerializer(help_text="Request Solutions", required=True, allow_null=False)


class SolutionSerializer(serializers.Serializer):
    placementSolutions = serializers.ListField(
        help_text="A list of Placement Solutions",
        child=serializers.ComprehensiveSolutionSerializer(help_text="One Placement Solution", required=True),
        required=True,
        allow_blank=True
    )
    licenseSolutions = serializers.ListField(
        help_text="A list of License Solutions",
        child=serializers.LicenseSolutionSerializer(help_text="One License Solution", required=True),
        required=True,
        allow_blank=True
    )


class ComprehensiveSolutionSerializer(serializers.ListField):
    child = serializers.PlacementSolutionSerializer(help_text="A list of placement solutions", required=True)
...
class PlacementSolutionSerializer(serializers.Serializer):
    ...
    solution = serializers.CandidateSerializer(help_text="The Placement Solution", required=True)
    assignmentInfo = serializers.ListField(
        help_text="Additional information related to a candidate",
        child=serializers.AssignmentInfoSerializer(help_text="Additonal information related to a candidate",
                                                   required=True),
        required=False,
        allow_blank=True
    )
