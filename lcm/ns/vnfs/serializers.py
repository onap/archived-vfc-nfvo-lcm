...
class SolutionSerializer(serializers.Serializer):
    placementSolutions = ComprehensiveSolutionSerializer(help_text="A list of Placement Solutions", required=True, allow_empty=True, many=True)
    licenseSolutions = LicenseSolutionSerializer(help_text="A list of License Solutions", required=True, allow_empty=True, many=True)
...
class PlaceVnfReqSerializer(serializers.Serializer):
    ...
    solutions = SolutionSerializer(help_text="Request Solutions", required=True, allow_null=False, many=False)