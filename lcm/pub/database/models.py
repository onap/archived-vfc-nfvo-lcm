...
class NSDModel(models.Model):
    ...
    vendor = models.CharField(
        db_column='VENDOR', max_length=200, null=True, blank=True)
    description = models.CharField(
        db_column='DESCRIPTION', max_length=200, null=True, blank=True)
    version = models.CharField(
        db_column='VERSION', max_length=200, null=True, blank=True)
    nsd_model = models.TextField(
        db_column='NSDMODEL', max_length=65535, null=True, blank=True)
    nsd_path = models.CharField(
        db_column='NSDPATH', max_length=300, null=True, blank=True)
...
class NSInstModel(models.Model):
    ...
    id = models.CharField(db_column='ID', primary_key=True, max_length=200)
    name = models.CharField(db_column='NAME', max_length=200)
    nspackage_id = models.CharField(
        db_column='NSPACKAGEID', max_length=200, null=True, blank=True)
    nsd_id = models.CharField(db_column='NSDID', max_length=200)
    nsd_invariant_id = models.CharField(
        db_column='NSDINVARIANTID', max_length=200)
    description = models.CharField(
        db_column='DESCRIPTION', max_length=255, null=True, blank=True)
    sdncontroller_id = models.CharField(
        db_column='SDNCONTROLLERID', max_length=200, null=True, blank=True)
    flavour_id = models.CharField(
        db_column='FLAVOURID', max_length=200, null=True, blank=True)
    ns_level = models.CharField(
        db_column='NSLEVEL', max_length=200, null=True, blank=True)
    status = models.CharField(
        db_column='STATUS', max_length=200, null=True, blank=True)
    nsd_model = models.TextField(
        db_column='NSDMODEL', max_length=20000, null=True, blank=True)
    input_params = models.TextField(
        db_column='INPUTPARAMS', max_length=2000, null=True, blank=True)
    scale_params = models.TextField(
        db_column='SCALEPARAMS', max_length=2000, null=True, blank=True)
    create_time = models.CharField(
        db_column='CREATETIME', max_length=200, null=True, blank=True)
    lastuptime = models.CharField(
        db_column='LASTUPTIME', max_length=200, null=True, blank=True)
    global_customer_id = models.CharField(
        db_column='GLOBALCUSTOMERID', max_length=50, null=True, blank=True)
    service_type = models.CharField(
        db_column='SERVICETYPE', max_length=50, null=True, blank=True)
...
class NfPackageModel(models.Model):
    ...
    vnfdmodel = models.TextField(
        db_column='VNFDMODEL', max_length=65535, blank=True, null=True)
    vnfd_path = models.CharField(
        db_column='VNFDPATH', max_length=300, null=True, blank=True)
...
class FPInstModel(models.Model):
    ...
    fpinstid = models.CharField(
        db_column='FPINSTID', max_length=255, primary_key=True)
    ...
    forworderpaths = models.CharField(
        db_column='FORWORDERPATHS', max_length=255, null=True, blank=True)
    status = models.CharField(db_column='STATUS', max_length=255)
    sdncontrollerid = models.CharField(
        db_column='SDNCONTROLLERID', max_length=255)
    sfcid = models.CharField(db_column='SFCID', max_length=255)
    flowclassifiers = models.CharField(
        db_column='FLOWCLASSIFIERS', max_length=255)
    portpairgroups = models.TextField(
        db_column='PORTPAIRGROUPS', max_length=65535)
...
class VNFFGInstModel(models.Model):
    ...
    vnffginstid = models.CharField(
        db_column='VNFFGINSTID', max_length=255, primary_key=True)
    nsinstid = models.CharField(db_column='NSINSTID', max_length=255)
    desc = models.CharField(
        db_column='DESC', max_length=255, blank=True, null=True)
    vendor = models.CharField(
        db_column='VENDOR', max_length=255, blank=True, null=True)
    version = models.CharField(
...
class NfInstModel(models.Model):
    ...
    nfinstid = models.CharField(
        db_column='NFINSTID', max_length=200, primary_key=True)
    mnfinstid = models.CharField(
        db_column='M_NFINSTID', max_length=200, blank=True, null=True)
    nf_name = models.CharField(
        db_column='NFNAME', max_length=100, blank=True, null=True)
    template_id = models.CharField(
        db_column='TEMPLATEID', max_length=200, blank=True, null=True)
    vnf_id = models.CharField(
        db_column='VNFID', max_length=200, blank=True, null=True)
    package_id = models.CharField(
        db_column='PACKAGEID', max_length=200, blank=True, null=True)
    vnfm_inst_id = models.CharField(
        db_column='VNFMINSTID', max_length=200, blank=True, null=True)
    ns_inst_id = models.CharField(
        db_column='NSINSTID', max_length=200, blank=True, null=True)
    status = models.CharField(
        db_column='STATUS', max_length=20, blank=True, null=True)
    flavour_id = models.CharField(
        db_column='FLAVOURID', max_length=200, blank=True, null=True)
    vnf_level = models.CharField(
        db_column='VNFLEVEL', max_length=200, blank=True, null=True)
    ...
    vendor = models.CharField(
        db_column='VENDOR', max_length=255, null=True, blank=True)
    vnfd_model = models.TextField(
        db_column='VNFDMODEL', max_length=20000, blank=True, null=True)
    input_params = models.TextField(
        db_column='INPUTPARAMS', max_length=2000, blank=True, null=True)
    scale_params = models.TextField(
        db_column='SCALEPARAMS', max_length=2000, null=True, blank=True)
    create_time = models.CharField(
        db_column='CREATETIME', max_length=200, null=True, blank=True)
    lastuptime = models.CharField(
        db_column='LASTUPTIME', max_length=200, blank=True, null=True)
    extension = models.TextField(
        db_column='EXTENSION', max_length=65535, blank=True, null=True)
...
class VmInstModel(models.Model):
    ...
    operationalstate = models.IntegerField(
        db_column='OPERATIONALSTATE', default=1)
    ...
    detailinfo = models.CharField(
        db_column='DETAILINFO', max_length=255, null=True)
...
class VNFCInstModel(models.Model):
    ...
    vnfcinstanceid = models.CharField(
        db_column='VNFCINSTANCEID', max_length=255, primary_key=True)
...
class CPInstModel(models.Model):
    ...
    cpinstanceid = models.CharField(
        db_column='CPINSTANCEID', max_length=255, primary_key=True)
    cpdid = models.CharField(db_column='CPDID', max_length=255)
    cpinstancename = models.CharField(
        db_column='CPINSTANCENAME', max_length=255)
    ...
    relatedvl = models.CharField(
        db_column='RELATEDVL', max_length=255, blank=True, null=True)
    relatedcp = models.CharField(
        db_column='RELATEDCP', max_length=255, blank=True, null=True)
    relatedport = models.CharField(
        db_column='RELATEDPORT', max_length=255, blank=True, null=True)
    status = models.CharField(db_column='STATUS', max_length=255)
...
class VLInstModel(models.Model):
    ...
    vlinstanceid = models.CharField(
        db_column='VLINSTANCEID', max_length=255, primary_key=True)
    vldid = models.CharField(db_column='VLDID', max_length=255)
    vlinstancename = models.CharField(
        db_column='VLINSTANCENAME', max_length=255, blank=True, null=True)
    ownertype = models.IntegerField(db_column='OWNERTYPE')
    ownerid = models.CharField(db_column='OWNERID', max_length=255)
    relatednetworkid = models.CharField(
        db_column='RELATEDNETWORKID', max_length=255, blank=True, null=True)
    relatedsubnetworkid = models.CharField(
        db_column='RELATEDSUBNETWORKID', max_length=255, blank=True, null=True)
...
class PortInstModel(models.Model):
    ...
    portid = models.CharField(
        db_column='PORTID', max_length=255, primary_key=True)
    ...
    operationalstate = models.CharField(
        db_column='OPERATIONALSTATE', max_length=255)
    ...
    floatipaddress = models.CharField(
        db_column='FLOATIPADDRESS', max_length=255)
    serviceipaddress = models.CharField(
        db_column='SERVICEIPADDRESS', max_length=255)
    typevirtualnic = models.CharField(
        db_column='TYPEVIRTUALNIC', max_length=255)
    sfcencapsulation = models.CharField(
        db_column='SFCENCAPSULATION', max_length=255)
...
class JobModel(models.Model):
    ...
    jobid = models.CharField(
        db_column='JOBID', primary_key=True, max_length=255)
    ...
    starttime = models.CharField(
        db_column='STARTTIME', max_length=255, null=True, blank=True)
    endtime = models.CharField(
        db_column='ENDTIME', max_length=255, null=True, blank=True)
    progress = models.IntegerField(db_column='PROGRESS', null=True, blank=True)
    user = models.CharField(
        db_column='USER', max_length=255, null=True, blank=True)
    parentjobid = models.CharField(
        db_column='PARENTJOBID', max_length=255, null=True, blank=True)
    resname = models.CharField(
        db_column='RESNAME', max_length=255, null=True, blank=True)
...
class JobStatusModel(models.Model):
    ...
    errcode = models.CharField(
        db_column='ERRCODE', max_length=255, null=True, blank=True)
    addtime = models.CharField(
        db_column='ADDTIME', max_length=255, null=True, blank=True)
...
class DefPkgMappingModel(models.Model):
    ...
    service_id = models.CharField(
        db_column='serviceId', max_length=255, primary_key=True)
...
class InputParamMappingModel(models.Model):
    ...
    input_value = models.CharField(
        db_column='inputValue', max_length=255, null=True, blank=True)
...
class WFPlanModel(models.Model):
    ...
    deployed_id = models.CharField(
        db_column='DEPLOYEDID', max_length=255, primary_key=True)
...
class OOFDataModel(models.Model):
    ...
    transaction_id = models.CharField(
        db_column='TRANSACTIONID', max_length=255)
    request_status = models.CharField(db_column='REQUESTSTATUS', max_length=50)
    request_module_name = models.CharField(
        db_column='RESOURCEMODULENAME', max_length=100)
    service_resource_id = models.CharField(
        db_column='SERVICERESOURCEID', max_length=255, primary_key=True)
    vim_id = models.CharField(
        db_column='VIMID', max_length=255, null=True, blank=True)
    cloud_owner = models.CharField(
        db_column='CLOUDOWNER', max_length=100, null=True, blank=True)
    cloud_region_id = models.CharField(
        db_column='CLOUDREGIONID', max_length=255, null=True, blank=True)
    vdu_info = models.TextField(
        db_column='VDUINFO', max_length=65535, null=True, blank=True)
...
class SubscriptionModel(models.Model):
    ...
    subscription_id = models.CharField(
        db_column='SUBSCRIPTIONID', max_length=255, primary_key=True)
    auth_info = models.TextField(
        db_column='AUTHINFO', max_length=20000, blank=True, null=True)
    vnf_instance_filter = models.TextField(
        db_column='VNFINSTANCEFILTER', null=True)
    ns_instance_filter = models.TextField(
        db_column='NSINSTANCEFILTER', null=True)
    notification_types = models.TextField(
        db_column='NOTIFICATIONTYPES', null=True)
    ...
    nscomponent_types = models.TextField(
        db_column='NSCOMPONENTTYPES', null=True)
    lcmopname_impacting_nscomponent = models.TextField(
        db_column='LCMOPNAMEIMPACTINGNSCOMPONENT', null=True)
    lcmopoccstatus_impacting_nscomponent = models.TextField(
        db_column='LCMOPOCCSTATUSIMPACTINGNSCOMPONENT', null=True)
...
class PNFInstModel(models.Model):
    ...
    pnfId = models.CharField(
        db_column='PNFID', primary_key=True, max_length=255)
    ...
    cpInfo = models.TextField(
        db_column='CPINFO', max_length=255, null=True, blank=True)
    emsId = models.CharField(db_column='EMSID', null=True, max_length=255)
    nsInstances = models.TextField(
        db_column='NSINSTANCES', max_length=1000, null=True, blank=True)
